  ...
  render() {
    ...
    return (
      <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:scale-105 transition-all duration-300">
        <NavLink to={`/productdetails/${id}`} className="flex flex-col h-[120px]  items-start justify-between  pb-2">
          <div className="w-full lg:h-48 h-[50px] bg-gray-100 flex items-center justify-center">
            <img 
              src={image} 
              alt={name} 
          ...
          <div className="pr-2 pl-2 h-fit">
            <h3 className="md:text-lg text-[8px] font-semibold mb-2 line-clamp-1 ">{name}</h3>
            <p className="text-gray-600 text-[8px] mb-3 line-clamp-2 hidden md:block">
              {description}
            </p>
